...
func getEmailFromV2JSON(json *simplejson.Json) (string, error) {
	var email string
	var err error
...
func (p *AzureV2Provider) GetEmailAddress(s *sessions.SessionState) (string, error) {
	var email string
	var err error
	...
	email, err = getEmailFromV2JSON(json)
